...
* RedCloth
* Linguistics
* validation_reflection (redinger-validation_reflection)

h2. Plugins

The "Launching Soon":http://github.com/vinsol/Launching-Soon/ plugin is included as a Git submodule and it is MIT licensed.

The "Validatious-on-Rails"http://github.com/grimen/validatious-on-rails/ plugin is also included as a Git submodule and it is also MIT licensed.
